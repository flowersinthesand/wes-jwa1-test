...
public class ServerWebSocketTest extends ServerWebSocketTestTemplate {
	...
	protected void startServer() throws Exception {
		...
		// It seems that this line is required in Tomcat 7
		context.addServletContainerInitializer(new WsSci(), Collections.<Class<?>> singleton(ServerApplicationConfig.class));
		tomcat.start();
